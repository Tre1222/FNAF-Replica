...
> **Status:** Production -- Making the Game
...
This is a learning project — built to understand state-driven game systems (animatronic AI, room states, power management) and the horror atmosphere that makes FNAF work.

## Tech Stack

- **Engine:** [Godot 4.6](https://godotengine.org/)
- **Language:** GDScript + C# (using both — GDScript for fast iteration on room/UI logic, C# for reusable systems like the animatronic AI scheduler)
